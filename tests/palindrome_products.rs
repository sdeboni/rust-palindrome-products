...
#[test]
fn detect_palindrome_single_digit_1() {
    assert!(is_palindrome(1));
}

#[test]
fn detect_palindrome_single_digit_9() {
    assert!(is_palindrome(9));
}

#[test]
fn detect_palindrome_double_digit_11() {
    assert!(is_palindrome(11));
}

#[test]
fn detect_palindrome_double_digit_55() {
    assert!(is_palindrome(55));
}

#[test]
fn detect_palindrome_triple_digit_homog_555() {
    assert!(is_palindrome(555));
}

#[test]
fn detect_palindrome_triple_digit_hetrog_515() {
    assert!(is_palindrome(515));
}

#[test]
fn detect_palindrome_5_digits_hetrog_12321() {
